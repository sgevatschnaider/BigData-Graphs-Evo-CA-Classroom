...
| **PG_Crecimiento combinatorio del espacio.html** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Simulador interactivo del crecimiento combinatorio del espacio de programas en Programación Genética. Permite ajustar la cantidad de terminales (|T|), funciones (|F|), la aridad media k y la profundidad máxima d, visualizando la recurrencia N(d) ≈ |T| + |F|·(N(d−1))^k. Incluye gráfico con escala lineal/log10, tabla de valores, exportación a CSV y descarga del gráfico en PNG, ideal para mostrar por qué el espacio de búsqueda en PG explota de forma tan rápida.</p></details> | [![Ver simulador](https://img.shields.io/badge/Ver-Simulador-purple?style=for-the-badge&logo=apachespark)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/PG_Crecimiento%20combinatorio%20del%20espacio.html) |
...
| 📄 Recurso | 📥 Acceso |
|---|---|
| **PG_Glosario.html** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Glosario interactivo de Programación Genética con términos clave como espacio de búsqueda, bloat, parsimonia, regresión simbólica y AlphaEvolve. Cada entrada se despliega en un acordeón con explicaciones extensas, pensadas para un estudio de nivel avanzado. Incluye buscador en tiempo real, botón de “término aleatorio” y sistema de marcado de términos revisados con barra de progreso para gamificar el aprendizaje.</p></details> | [![Ver Glosario](https://img.shields.io/badge/Ver-Glosario-orange?style=for-the-badge&logo=bookstack)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/PG_Glosario.html) |
