...
|**PG_crecimiento_combinatorio_del_espacio.html** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este recurso es un simulador interactivo que se enfoca exclusivamente en el crecimiento del espacio de búsqueda en Programación Genética (PG). A través de la fórmula de recurrencia N(d) ≈ |T| + |F|·(N(d−1))^k, la herramienta permite al usuario modificar el número de terminales (|T|), funciones (|F|), la aridad media (k) y la profundidad máxima (d). El resultado se visualiza en un gráfico que muestra el número de árboles posibles (programas) en función de la profundidad. Es una herramienta didáctica para comprender cómo pequeños cambios en los componentes básicos de la PG pueden llevar a un crecimiento descontrolado del espacio de soluciones.</p></details> | [![Explorar Crecimiento en PG](https://img.shields.io/badge/Explorar-Crecimiento%20Combinatorio%20en%20PG-9cf?style=for-the-badge&logo=html5)](https://clinquant-meringue-3930c2.netlify.app/src/classroom/graphs/recursos/pg_crecimiento%20combinatorio%20del%20espacio) |
