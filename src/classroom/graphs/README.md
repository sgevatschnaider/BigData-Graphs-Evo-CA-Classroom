...
| 📄 Recurso | 📥 Acceso |
|---|---|
| **Introducción a la Teoría y Aplicaciones de los Grafos (Notebook)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este cuaderno interactivo introduce los conceptos esenciales de la teoría de grafos, transformando una lección teórica en una aplicación web visual y dinámica. Explora las definiciones de vértices y aristas, y detalla los distintos tipos de grafos (dirigidos, no dirigidos, ponderados, bipartitos, etc.) a través de visualizaciones claras. La lección destaca por su construcción técnica: utiliza Python con <code>networkx</code> y <code>matplotlib</code> para generar los grafos, los convierte a formato Base64 y los incrusta en una página HTML con CSS y JavaScript para ofrecer una interfaz interactiva con temas claro/oscuro y secciones colapsables. El objetivo es proporcionar una comprensión intuitiva y práctica de cómo se modelan y analizan las redes y relaciones.</p></details> | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/fdacac884643cdc9f8d15c59e720ed19f50afca7/src/classroom/graphs/notebooks/Introducci%C3%B3n_a_la_teor%C3%ADa_y_aplicaciones_de_los_grafos_.ipynb) <br><br> [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-blue?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/fdacac884643cdc9f8d15c59e720ed19f50afca7/src/classroom/graphs/notebooks/Introducci%C3%B3n_a_la_teor%C3%ADa_y_aplicaciones_de_los_grafos_.ipynb) |
| **Lecciones Interactivas (HTML)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Versiones en HTML listas para abrir en el navegador. “Volumen” enfatiza la escala y la representación visual de redes; “Velocidad” enfatiza grafos dinámicos en tiempo real (edge streams) con algoritmos de una o pocas pasadas y memoria sublineal; y “Variedad” enfatiza estructuras heterogéneas (multigrafos, grafos dirigidos/atribuidos, hipergrafos) y consultas estructurales.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Volumen-orange?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/70bb59083bd25cde5233f9eb44385f6de074c436/src/classroom/graphs/recursos/Introducci%C3%B3n_a_la_teor%C3%ADa_y_aplicaciones_de_los_grafos_Internet_Volumen.html) <br><br> [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Velocidad-orange?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/46fae73f6d04e4265083e43076d8db2be400c2e3/src/classroom/graphs/recursos/Introducci%C3%B3n_a_la_teor%C3%ADa_y_aplicaciones_de_los_grafos_Internet_Velocidad.html) <br><br> [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Variedad-orange?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/ca006d0c5f5387201994b4596d6ec2b290c0ebe9/src/classroom/graphs/recursos/Introducci%C3%B3n_a_la_teor%C3%ADa_y_aplicaciones_de_los_grafos_Internet_Variedad.html) |
| **Cuestionario de Grafos a Escala (HTML interactivo)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este material interactivo presenta un examen desarrollado sobre grafos a gran escala, centrado en los principales desafíos conceptuales y computacionales que surgen cuando un grafo ya no puede tratarse exhaustivamente. El cuestionario aborda de manera progresiva y detallada temas como la imposibilidad de cargar grafos masivos completos en memoria, el costo dominante de I/O, las limitaciones de las representaciones exactas tradicionales y la necesidad de adoptar estrategias de reducción o aproximación.</p><p>El contenido profundiza en tres grandes enfoques para trabajar con grafos masivos: <strong>muestreo</strong>, <strong>sketching</strong> y <strong>sparsificación</strong>. Explica qué preserva cada técnica, qué sacrifica, en qué contextos resulta más adecuada y cómo se relaciona con parámetros como <code>ε</code> y <code>δ</code>, procesamiento en streaming, mergeabilidad y preservación estructural. El cuestionario también destaca el papel de conceptos como random walks, laplaciano y sparsificación espectral.</p><p>Desde el punto de vista técnico, el recurso está implementado como una aplicación HTML interactiva con <strong>CSS</strong> y <strong>JavaScript</strong>, e incluye cambio de tema claro/oscuro, barra de progreso, búsqueda de conceptos, selección aleatoria de preguntas, seguimiento de preguntas dominadas mediante <code>localStorage</code> y una presentación expandible de preguntas y respuestas largas. El objetivo es ofrecer una herramienta de estudio profunda, clara y reutilizable para revisar teoría de grafos a escala con foco en comprensión conceptual rigurosa.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Cuestionario-orange?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/f75b8e2c924fd907cc70b7aeb79c7f7602080d0d/src/classroom/graphs/recursos/Cuestionario%20de%20Grafos%20a%20Escala.html) |


## 📝 El Paseo de Euler y Teoría de Grafos

| 📄 Recurso | 📥 Acceso |
|---|---|
| **El Paseo de Euler: Modelado Computacional del Problema de Königsberg (Notebook)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este cuaderno técnico traduce el histórico problema de los puentes de Königsberg al lenguaje de programación Python. Utiliza la librería <code>networkx</code> para modelar las masas de tierra como nodos y los puentes como aristas. El código permite validar computacionalmente el Teorema de Euler, demostrando que al tener nodos con grados impares (3 y 5), es imposible realizar un recorrido euleriano. Es una herramienta práctica para entender la abstracción de datos y la topología aplicada.</p></details> | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/15POW1YAoE3Z2CU3LBXLZZYIPlvOO5-x9) |
| **Análisis: Teoría de Grafos en la Práctica (Revista)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este artículo de la revista "Economía y Ética" explora la relevancia filosófica y estructural del hallazgo de Leonhard Euler en 1736. Explica cómo la resolución de un problema urbano dio origen a la Topología, priorizando las relaciones y conexiones sobre las distancias físicas. El texto vincula esta teoría con la optimización de sistemas complejos en la economía moderna y el análisis de redes en la era del Big Data, destacando la importancia de la conectividad estructural.</p></details> | [![Leer artículo](https://img.shields.io/badge/Leer%20art%C3%ADculo-Revista-green?style=for-the-badge&logo=readthedocs)](https://economiayetica.blogspot.com/2025/08/el-paseo-de-euler-teoria-de-grafos_30.html) |
| **Los 7 Puentes de Königsberg — Grafo Equivalente (Simulación Interactiva)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este recurso interactivo representa el problema clásico de los 7 puentes de Königsberg mediante un grafo equivalente, permitiendo analizar visual y computacionalmente el Teorema de Euler. La simulación muestra los grados de cada vértice, verifica por qué el grafo original no admite camino euleriano ni ciclo euleriano, y permite modificar la estructura para construir escenarios donde sí exista un camino o un ciclo. Además, incorpora búsqueda de todos los recorridos posibles y un explorador con <code>DFS</code> y <code>backtracking</code> para observar paso a paso cómo se expande el árbol de decisiones. Es un material ideal para comprender la relación entre modelado abstracto, conectividad, grados e imposibilidad estructural en teoría de grafos.</p></details> | [![Simulación](https://img.shields.io/badge/Simulaci%C3%B3n-HTML%20Interactivo-blue?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://raw.githubusercontent.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/eb2401098b1fd311199ac6f3b683d973d9591a33/src/classroom/graphs/recursos/Euler_%20los%20Puentes%20de%20Koningsberg.html) |
...
## 📝Grafos, distancia, geometría y paseos aleatorios
...
| 📄 Recurso | 📥 Acceso |
|---|---|
| **El grafo del infinito (Notebook en Google Colab)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este cuaderno en Google Colab desarrolla el estudio del grafo infinito sobre <code>ℤ²</code> como extensión natural de una grilla finita. Presenta la definición formal del grafo, sus propiedades estructurales —conectividad, regularidad, bipartición, simetrías y ausencia de borde— y su relación con el paseo aleatorio simple. El material funciona como base teórica y computacional para comprender la recurrencia en dimensión dos, la probabilidad de retorno al origen y la conexión entre grafos, probabilidad y análisis.</p></details> | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/159n9ZP_CJnUuUNF-bSCnIQyTLaxwUGuL?usp=sharing) |
| **Paseo aleatorio del número pi (HTML interactivo)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este recurso interactivo explora el paseo aleatorio simple sobre <code>ℤ²</code> y su vínculo con la constante <code>π</code>. La simulación visualiza la difusión empírica sobre la grilla, estima probabilidades de retorno al origen y compara numéricamente la ley asintótica <code>p₂ₙ(0,0) ∼ 1/(πn)</code>. Además, incorpora estimadores de <code>π</code> basados en sumas acumuladas y ajustes sobre los datos simulados, gráficos de convergencia, bandas de error, controles de velocidad, suavizado y cambio de tema visual. Es un material ideal para conectar teoría probabilística, evidencia computacional e intuición geométrica en un entorno interactivo.</p></details> | [![HTML Interactivo](https://img.shields.io/badge/HTML-Interactivo-blue?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://raw.githubusercontent.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/ed2889f391d8528c8d64999358e88fe6129cc5d9/src/classroom/graphs/recursos/paseo-aleatorio-pi.html) |
| **Cuestionario: Caminante Aleatorio y π (HTML interactivo)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este material interactivo desarrolla, en formato de examen con preguntas y respuestas extensas, la relación entre el <strong>caminante aleatorio</strong> y la aparición de <code>π</code> en el estudio de paseos aleatorios sobre la red bidimensional <code>ℤ²</code>. El recurso parte de la definición de caminante aleatorio como un proceso probabilístico sobre un grafo infinito regular, y explica por qué la probabilidad de retorno al origen en tiempos pares exhibe una ley asintótica del tipo <code>P(S₂ₙ = 0) ∼ 1/(πn)</code>.</p><p>El contenido muestra cómo esta propiedad permite construir estimadores numéricos de <code>π</code> a partir de simulaciones. Se analizan cantidades como <code>p̂₂ₙ</code>, el producto <code>n p̂₂ₙ</code>, la suma acumulada de probabilidades de retorno, el número armónico <code>Hₙ</code> y modelos de ajuste como <code>a \ln n + b + c/n</code>. También se discuten la importancia de considerar solo tiempos pares, el papel de las réplicas independientes, la diferencia entre ajustes puntuales y acumulados, y la interpretación del comportamiento asintótico.</p><p>Desde el punto de vista técnico, el recurso está implementado como una aplicación HTML interactiva con <strong>CSS</strong> y <strong>JavaScript</strong>, e incluye cambio de tema claro/oscuro, barra de progreso, búsqueda de conceptos, selección aleatoria de preguntas, reinicio de progreso, seguimiento de preguntas dominadas mediante <code>localStorage</code> y secciones expandibles para cada respuesta. Además, incorpora recuadros introductorios de conceptos clave para orientar el estudio. El objetivo es ofrecer una herramienta rigurosa, visual y reutilizable para comprender cómo un proceso dinámico sobre grafos puede conectarse con una constante matemática tan fundamental como <code>π</code>.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Caminante%20Aleatorio-orange?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/3f59f5f8fb2b52b97e938f1ec834fd22d3963959/src/classroom/graphs/recursos/Caminante%20Aleatorio%20y%20%CF%80.html) |
...
## 📝 Grafos regulares, small-world, hipercubos y teseracto

Esta sección reúne una serie de materiales HTML interactivos y un artículo complementario orientados a estudiar, de manera articulada, cómo se relacionan la regularidad en la conectividad, la estructura topológica de las redes, la transición entre orden y aleatoriedad, y la representación de objetos en dimensiones superiores.

El recorrido está organizado como una secuencia pedagógica: primero se introduce la noción de grafo regular y sus principales familias canónicas; luego se explora cómo esa regularidad puede extenderse hacia estructuras de mayor dimensión mediante los hipercubos; a continuación se analiza la transición entre redes regulares, redes de mundo pequeño y grafos aleatorios para comprender cómo cambian propiedades globales como el clustering y la longitud media de camino; y finalmente se incorpora una lectura complementaria sobre el teseracto, que amplía la intuición geométrica y conceptual sobre las estructuras multidimensionales.

| Recurso | Enlace |
|---|---|
| **Grafos regulares: simetría y estructura en redes** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este recurso interactivo introduce la idea de grafo regular como una forma de organización en la que todos los nodos comparten el mismo número de conexiones. A partir de esa condición de simetría local, el material permite explorar cómo surgen estructuras muy distintas pero igualmente ordenadas, y cómo la regularidad constituye una noción central para comprender patrones de conectividad en teoría de grafos. La propuesta resulta especialmente útil porque traduce una definición abstracta en ejemplos visuales y comparables, facilitando la comprensión de conceptos como grado, equilibrio estructural y organización topológica. Es una excelente puerta de entrada para pensar cómo la uniformidad en las conexiones puede dar lugar a geometrías discretas con propiedades matemáticas y aplicadas de gran relevancia.</p></details> | [![HTML Interactivo](https://img.shields.io/badge/HTML-Interactivo-blue?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/152cad48af709248487ffa9c0e672c2cc29eae0d/src/classroom/graphs/recursos/2.Grafos_regulares.html) |
| **Hipercubos: de la regularidad bidimensional al teseracto** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este HTML muestra cómo una misma lógica de regularidad puede extenderse progresivamente desde estructuras simples hasta configuraciones de mayor dimensión. A través de la secuencia que va del punto y la línea al cuadrado, el cubo y el teseracto, el recurso permite visualizar que los hipercubos no son solo objetos abstractos, sino una generalización ordenada y coherente de la conectividad regular. El valor del material radica en que vuelve intuitiva una construcción matemática que suele parecer lejana, conectando representación geométrica, estructura binaria y pensamiento multidimensional. De este modo, la propuesta ofrece una forma clara de comprender cómo crecen las redes regulares cuando se las proyecta a dimensiones superiores.</p></details> | [![HTML Interactivo](https://img.shields.io/badge/HTML-Interactivo-blue?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/152cad48af709248487ffa9c0e672c2cc29eae0d/src/classroom/graphs/recursos/Grafos%20Regulares_hipercubos.html) |
| **Distancia de Hamming en el cubo: solución de un problema del AMC 10A 2009** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este recurso interactivo presenta la resolución visual y paso a paso de un problema clásico de olimpíada matemática: determinar la probabilidad de que el plano definido por tres vértices elegidos al azar en un cubo corte efectivamente su interior. La propuesta reformula el cubo como \(\{0,1\}^3\), representando sus vértices mediante cadenas binarias, y utiliza la distancia de Hamming para clasificar las ternas posibles según sus patrones de separación. De este modo, un problema geométrico se traduce en una estructura combinatoria clara, permitiendo identificar qué configuraciones corresponden a una misma cara y cuáles generan un plano que atraviesa el interior del sólido. El valor del material radica en que conecta geometría discreta, representación binaria, visualización interactiva y razonamiento matemático en una misma secuencia didáctica.</p></details> | [![HTML Interactivo](https://img.shields.io/badge/HTML-Interactivo-blue?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/b3734d4ff16215e956cc98d2c9c6a62e3f13fc04/src/classroom/graphs/recursos/Hamming_cubo_problema%20matem%C3%A1tico.html) |
| **Redes de mundo pequeño: entre el orden y el azar** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este recurso interactivo permite comprender una de las ideas más influyentes de la teoría de redes: que una estructura puede conservar cierto orden local y, al mismo tiempo, reducir notablemente las distancias globales entre nodos. Mediante la comparación entre redes regulares, redes small-world y grafos aleatorios, el material muestra que pequeñas modificaciones en la conectividad pueden transformar de manera profunda la dinámica y la eficiencia de una red. La propuesta es especialmente valiosa porque hace visible la transición entre orden, reorganización y aleatoriedad, y ayuda a interpretar por qué muchas redes reales presentan propiedades intermedias entre ambos extremos. En ese sentido, funciona como una introducción visual y conceptual muy potente al estudio de sistemas complejos.</p></details> | [![HTML Interactivo](https://img.shields.io/badge/HTML-Interactivo-blue?style=for-the-badge&logo=google-chrome)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/152cad48af709248487ffa9c0e672c2cc29eae0d/src/classroom/graphs/recursos/Grafos_%20regulares%20small_world_network.html) |
| **Teseracto: más allá de la dimensión visible** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este artículo ofrece una aproximación conceptual al teseracto como extensión natural del cubo hacia una cuarta dimensión. Su interés no reside solo en presentar una figura geométrica llamativa, sino en invitar a pensar cómo se generalizan las formas, las relaciones espaciales y las simetrías cuando se supera el marco intuitivo de las tres dimensiones. El texto resulta especialmente útil como complemento de los recursos sobre hipercubos y grafos regulares, porque aporta una mirada más reflexiva sobre la representación de objetos de alta dimensión y sobre los límites de nuestra intuición espacial. En conjunto, propone un puente muy sugerente entre imaginación geométrica, formalización matemática y visualización de estructuras complejas.</p></details> | [![Artículo / Blog](https://img.shields.io/badge/Artículo-Blog-orange?style=for-the-badge&logo=blogger)](https://economiayetica.blogspot.com/2025/04/teseracto-mas-alla-de-la-dimension_10.html) |

## 📝 Mundo pequeño y teoría de las redes

| 📄 Recurso | 📥 Acceso |
|---|---|
| **El fenómeno del mundo pequeño (Notebook de Google Colab)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este cuaderno interactivo desarrolla de forma integral el fenómeno del mundo pequeño a través de una secuencia extensa de capítulos organizados como material de estudio. Recorre la definición del small world, su origen histórico, los fundamentos de teoría de grafos, el problema entre orden local y conectividad global, el modelo de Watts–Strogatz, las propiedades matemáticas del fenómeno, el papel de los atajos, la evidencia empírica, su relación con redes sociales, redes aleatorias y redes libres de escala, sus implicaciones dinámicas, sus métodos de medición, sus límites, sus aplicaciones contemporáneas y una bibliografía final. Técnicamente, el notebook combina <code>Python</code>, <code>networkx</code> y <code>matplotlib</code> con generación de interfaces HTML embebidas, visualizaciones en Base64 y secciones interactivas pensadas para Google Colab. El resultado es una pieza didáctica robusta que transforma un desarrollo teórico amplio en un entorno visual, navegable y reutilizable para docencia y estudio.</p></details> | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1w3GLXz1uiv-gkNYVJ9h7x7Z1krWAv4yH?usp=sharing) |
| **Mundo pequeño: simulación interactiva del modelo de Watts–Strogatz (HTML)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Esta simulación visualiza en tiempo real la transición entre red regular, región small-world y red más aleatoria dentro del modelo de Watts–Strogatz. Permite manipular la probabilidad de reconexión <code>p</code>, el número de nodos <code>n</code> y el grado inicial <code>k</code>, regenerar la red, animar el proceso de reconexión y buscar rutas mínimas entre nodos. La interfaz muestra además métricas estructurales clave como el clustering promedio, la longitud media de camino, sus comparaciones con redes aleatorias equivalentes y un índice explícito de small-worldness. Desde el punto de vista técnico, está construida como una aplicación HTML con <code>JavaScript</code> y <code>D3.js</code>, con paneles laterales, leyenda visual, modo interactivo y actualización dinámica de indicadores. Su valor didáctico está en mostrar cómo unos pocos atajos pueden reducir drásticamente las distancias sin destruir inmediatamente la cohesión local.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Simulaci%C3%B3n-orange?style=for-the-badge&logo=html5)](https://clinquant-meringue-3930c2.netlify.app/src/classroom/graphs/recursos/mundo_peque%C3%B1o_simulacion) |
...
| **Ciclo_Coloración_cromatica.html** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este recurso interactivo permite comprender visualmente la coloración de vértices en ciclos \(C_n\) y el concepto de número cromático \(\chi(G)\). A través de una simulación dinámica, muestra cómo se colorean los vértices de un ciclo evitando que dos vértices adyacentes compartan el mismo color. El recurso compara ciclos pares e impares: en los ciclos pares, la alternancia entre dos colores cierra correctamente, por lo que \(\chi(C_n)=2\); en los ciclos impares, el intento con dos colores genera un conflicto al cerrar el ciclo, lo que obliga a incorporar un tercer color, obteniendo \(\chi(C_n)=3\). Incluye selector de casos, deslizador para modificar el número de vértices, botón de simulación, botón de solución mínima, reinicio, cambio de tema visual, registro paso a paso y explicación matemática integrada.</p></details> | [![Abrir Coloración Cromática](https://img.shields.io/badge/Abrir-Coloraci%C3%B3n%20Crom%C3%A1tica-f59e0b?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/fd2927426d21ab620fd0a68aa80dedba6a68c962/src/classroom/graphs/recursos/Ciclo_Coloraci%C3%B3n_cromatica.html) |
...
| **1. Visualización del plano hiperbólico** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Introducción visual al plano hiperbólico y a sus diferencias con la geometría euclidiana. La visualización permite observar cómo se comportan las distancias, las curvas, las deformaciones y la estructura del espacio cuando la curvatura es negativa. Es un recurso inicial para comprender por qué el plano hiperbólico resulta útil al representar grafos con crecimiento expansivo o estructuras jerárquicas.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_Visualizaci%C3%B3n%20del%20plano%20hiperb%C3%B3lico.html) |
| **2. Disco de Poincaré** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Visualización interactiva del <strong>modelo del disco de Poincaré</strong>, uno de los modelos más utilizados para representar la geometría hiperbólica. El recurso permite comprender cómo todo el plano hiperbólico puede proyectarse dentro de un disco euclidiano finito, donde las distancias se expanden hacia el borde y las geodésicas aparecen como diámetros o arcos ortogonales a la frontera.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_Disco%20de%20Poincar%C3%A9.html) |
| **3. Teselación estilo disco de Poincaré** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Recurso visual y ornamental que muestra una teselación inspirada en el disco de Poincaré. Permite observar cómo patrones repetidos pueden cubrir el espacio hiperbólico de manera diferente a una teselación euclidiana. La visualización ayuda a comprender la expansión del espacio hacia el borde del disco y la relación entre simetría, curvatura negativa y estructura geométrica.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_Teselaci%C3%B3n%20estilo%20disco%20de%20Poincar%C3%A9.html) |
| **4. Disco de Poincaré con árbol interactivo** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Simulación interactiva que representa un árbol dentro del disco de Poincaré. El recurso permite visualizar por qué la geometría hiperbólica es especialmente adecuada para grafos jerárquicos: a medida que aumentan los niveles del árbol, el espacio disponible crece hacia el borde del disco, permitiendo ubicar más nodos sin colapsar la estructura visual.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/poincare_tree_interactive_html.html) |
| **5. Bola métrica en grafos** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Visualización dinámica del concepto de <strong>bola métrica</strong> en un grafo. A partir de un nodo central y un radio determinado, se muestra el conjunto de vértices alcanzables según la distancia interna del grafo. El recurso permite comparar cómo se expanden las bolas métricas en distintos tipos de grafos y conectar esta expansión discreta con el crecimiento de volumen en geometrías continuas.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_Bola%20m%C3%A9trica.html) |
| **6. Grafos conexos no ponderados** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Explicación matemática y visual de los grafos conexos no ponderados como espacios métricos discretos. El recurso muestra cómo definir una distancia interna entre vértices mediante la longitud del camino más corto y cómo esa distancia permite estudiar bolas métricas, expansión, estructura global y posibles embeddings hacia espacios euclidianos o hiperbólicos.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_SGrafos%20conexos%20no%20ponderados.html) |
| **7. Espacio geométrico y grafos** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Recurso dedicado a conectar grafos discretos con espacios geométricos continuos. Presenta la idea de un embedding como una función que transforma vértices en puntos de un espacio destino, preservando en lo posible relaciones de distancia, vecindad o jerarquía. La visualización permite comparar distintos espacios geométricos de representación, como el espacio euclidiano, la distancia Manhattan, el modelo hiperbólico, el espacio esférico y la similitud coseno. Es una pieza clave para comprender cómo se pasa de una estructura combinatoria a una representación geométrica analizable, y por qué la elección del espacio destino influye en la calidad del embedding.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_Espacio_Geom%C3%A9trico_y_Grafos_Tipos.html) |
| **8. Tipos de embeddings: grafos, texto, imágenes y más** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Panorama amplio sobre distintos tipos de embeddings aplicados a grafos, texto, imágenes y otros datos. El recurso explica cómo objetos discretos o complejos pueden transformarse en vectores o puntos de un espacio geométrico, permitiendo medir similitud, distancia, agrupamiento y relaciones semánticas o estructurales. Incluye una mirada comparativa entre dominios y aplicaciones.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_Tipos%20de%20embeddings%20grafos%2C%20texto%2C%20im%C3%A1genes%20y%20m%C3%A1s.html) |
| **9. Embedding dinámico: simulación** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Simulación interactiva del proceso de embedding como transformación desde datos discretos hacia un espacio vectorial. El recurso permite observar cómo distintos objetos pueden convertirse en vectores, cómo se reorganizan en el espacio y cómo la cercanía geométrica puede interpretarse como similitud, relación estructural o proximidad semántica.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_embedding_dinamico_simulacion.html) |
| **10. Dashboard de distorsión de embeddings de grafos** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Dashboard interactivo para analizar la <strong>distorsión</strong> producida al embeber grafos en espacios geométricos. Permite comparar distancias originales del grafo con distancias en el espacio destino, observar errores relativos y evaluar la calidad de la representación. Es especialmente útil para comprender que un embedding no solo busca ubicar nodos visualmente, sino preservar de manera controlada la estructura métrica del grafo.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_dashboard_distorsion_embeddings_grafos.html) |
| **11. Crecimiento euclídeo, hiperbólico y árbol regular** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Comparación interactiva entre el crecimiento polinómico del plano euclídeo, el crecimiento exponencial del plano hiperbólico y el crecimiento ramificado de un árbol regular. El recurso permite modificar el radio geodésico, la ramificación del árbol y la velocidad de animación para observar cómo cambian las circunferencias, las áreas y la cantidad de nodos alcanzables. Es una pieza clave para comprender por qué la geometría hiperbólica se adapta tan bien a jerarquías, taxonomías y grafos ramificados: mientras el plano euclídeo crece de manera moderada, el plano hiperbólico y los árboles generan espacio de forma exponencial.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_Crecimiento%20eucl%C3%ADdeo%2C%20hiperb%C3%B3lico%20y%20%C3%A1rbol%20regular.html) |
| **12. Modelos de representación del espacio hiperbólico** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Lección interactiva dedicada a comparar distintos modelos de representación del espacio hiperbólico, incluyendo el disco de Poincaré, el modelo de Beltrami-Klein, el semiplano superior, el hiperboloide y la pseudoesfera. El recurso permite explorar visualmente cómo cada modelo conserva ciertas propiedades y sacrifica otras: algunos preservan ángulos, otros muestran geodésicas como segmentos rectos y otros facilitan la formulación algebraica mediante el espacio de Minkowski. Resulta especialmente útil para introducir la idea de que la geometría hiperbólica no se visualiza de una única manera, sino a través de modelos equivalentes que sirven para distintos objetivos matemáticos, pedagógicos y computacionales.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_modelos_hiperbolicos_v_2_html.html) |
| **13. De un grafo a un espacio métrico** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Visualización didáctica que explica cuándo un grafo puede interpretarse como un espacio métrico a partir de la distancia de camino mínimo. El recurso compara grafos conexos no dirigidos, árboles, grafos no conexos y grafos dirigidos, mostrando cómo cambian la conectividad, la simetría, la finitud de las distancias y las propiedades métricas. Además, introduce la relación entre el espacio métrico discreto <em>(V, d<sub>G</sub>)</em> y el proceso de embedding hacia un espacio geométrico <em>M</em>, donde se busca que las distancias del grafo se aproximen mediante distancias en el espacio destino. Es fundamental para conectar teoría de grafos, métricas, embeddings y geometría hiperbólica.</p></details> | [![Ver Lección Interactiva](https://img.shields.io/badge/Ver%20Lección-Interactiva-9cf?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_De%20un%20grafo%20a%20un%20espacio%20m%C3%A9trico.html) |
