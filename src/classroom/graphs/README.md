...
| 📄 Recurso | 📥 Acceso |
|---|---|
| **Gráfico de Cuadrícula (Taller Interactivo)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este cuaderno interactivo presenta el concepto de <strong>grafo de cuadrícula</strong>, una estructura fundamental en teoría de grafos donde los vértices representan posiciones en una matriz y las aristas conectan nodos adyacentes. Utilizando <code>networkx</code> y <code>matplotlib</code>, el cuaderno construye y visualiza diferentes cuadrículas, incrustando las imágenes en formato Base64 en una interfaz HTML enriquecida. El objetivo es mostrar de forma clara y práctica cómo se modelan estas redes, con secciones interactivas y visualización adaptable.</p></details> | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-blue?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/fbce1f11c388051e53c479325c4108daf6f2a964/src/classroom/graphs/notebooks/Gr%C3%A1fico_de_cuadr%C3%ADcula_.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sgevatschnaider/BigData-G)_)
