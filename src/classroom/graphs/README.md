...
Esta etapa muestra cómo se entrenan modelos o embeddings cuando el espacio de representación tiene una geometría específica. Primero se presenta **Gradient Descent** en espacio euclídeo, luego su versión estocástica, y finalmente **Riemannian Stochastic Gradient Descent**, donde los pasos de actualización deben respetar la geometría curva del espacio hiperbólico.

La secuencia está pensada de manera progresiva. Primero se introduce la idea general de descender sobre una función de pérdida. Luego se muestra qué cambia cuando el gradiente se calcula de manera estocástica. Finalmente, se analiza por qué en una geometría no euclidiana, como la bola de Poincaré, no alcanza con aplicar las reglas tradicionales del espacio plano.

| 📄 Recurso | 📥 Acceso HTML |
|---|---|
| **16. Gradient Descent euclídeo: simulador avanzado** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Simulador interactivo para explicar <strong>Gradient Descent</strong> como movimiento sobre una superficie de pérdida en espacio euclídeo. Permite observar el punto actual, la trayectoria de optimización, la norma del gradiente, el tamaño del paso, la pérdida y el diagnóstico del aprendizaje. Es conveniente ubicarlo antes de SGD y RSGD porque introduce la lógica base del descenso por gradiente: moverse iterativamente en la dirección que reduce la función de pérdida.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-Gradient%20Descent-38bdf8?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lico_GD.html) |
...
| **20. GD euclidiano vs RSGD: cómo se optimiza dentro de la bola de Poincaré** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Simulación comparativa que profundiza la diferencia entre aplicar un paso de <strong>Gradient Descent euclidiano</strong> y aplicar <strong>Riemannian Gradient Descent</strong> dentro de la bola de Poincaré. El recurso permite observar qué ocurre cuando el método euclidiano propone un punto fuera del espacio válido, muestra ese punto inválido en rojo y luego visualiza la proyección hacia el interior de la bola. En paralelo, el panel de RSGD muestra cómo el gradiente se reescala mediante el factor riemanniano, reduciendo el tamaño efectivo del paso cerca del borde. Es un recurso especialmente útil para explicar que RSGD no es simplemente proyectar después de moverse, sino adaptar el movimiento a la métrica del espacio antes de actualizar el punto.</p></details> | [![Ver HTML](https://img.shields.io/badge/Ver%20HTML-GD%20vs%20RSGD%20Poincar%C3%A9-a78bfa?style=for-the-badge&logo=html5)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Hiperb%C3%B3lica_GD%20euclidiano%20vs%20RSGD%20c%C3%B3mo%20se%20optimiza%20dentro%20de%20la%20bola%20de%20Poincar%C3%A9.html) |


## Lectura conceptual de la secuencia

La lógica de esta sección es avanzar desde la optimización clásica hacia la optimización geométrica.

En **Gradient Descent euclídeo**, el modelo actualiza sus parámetros dentro de un espacio plano. La dirección del movimiento se calcula a partir del gradiente de la función de pérdida, y el tamaño del paso depende de la tasa de aprendizaje.

En **Stochastic Gradient Descent**, la lógica es similar, pero el gradiente se estima usando muestras o mini-batches. Esto permite entrenar modelos grandes con menor costo computacional, aunque introduce ruido y trayectorias menos regulares.

En **RSGD**, el cambio conceptual es más profundo. El espacio ya no se trata como plano. Cuando los embeddings viven dentro de una variedad curva, como la bola de Poincaré, la forma de medir distancias cambia según la posición del punto. Por eso, el gradiente debe adaptarse a la métrica del espacio.
...
| **Cuestionario interactivo · Simetría, Grupos, Grafos y Big Data** <br><br> <details><summary><strong>Resumen:</strong> <em>haz clic para expandir o colapsar</em></summary><p>Cuestionario interactivo compuesto por 20 preguntas con respuestas completamente desarrolladas. El material permite repasar los conceptos centrales del recorrido: simetría del triángulo equilátero, grupo D₃, grafos de Cayley, generadores, composición de operaciones, identidad, inversos, no conmutatividad, teorema de Lagrange, clases laterales, sharding, MapReduce, asociatividad, hash, shuffle, Spark, RDD, linaje, memoria distribuida y tolerancia a fallos.</p><p>Está pensado como recurso de autoevaluación, repaso guiado y cierre conceptual para integrar matemática discreta, teoría de grupos, grafos y arquitecturas Big Data.</p></details> | [![Abrir HTML Interactivo](https://img.shields.io/badge/Abrir-HTML%20Interactivo-9cf?style=for-the-badge\&logo=html5\&logoColor=white)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Simetria_cuestionario_grupos_grafos_bigdata.html) <br><br> [![Ver Archivo en GitHub](https://img.shields.io/badge/Ver%20Archivo-GitHub-181717?style=for-the-badge\&logo=github)](https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Simetria_cuestionario_grupos_grafos_bigdata.html) |
| **Glosario interactivo · Simetría, Grupos, Grafos y Big Data** <br><br> <details><summary><strong>Resumen:</strong> <em>haz clic para expandir o colapsar</em></summary><p>Glosario interactivo con conceptos desarrollados sobre simetría, grupo D₃, teoría de grupos, grafos, grafos de Cayley, generadores, identidad, inversos, composición, no conmutatividad, particiones, clases laterales, sharding, MapReduce, Spark, RDD, linaje, invariancias en inteligencia artificial y arquitecturas distribuidas.</p><p>El recurso funciona como material de consulta rápida y apoyo conceptual para acompañar la presentación principal y el cuestionario. Incluye definiciones organizadas, buscador, categorías temáticas y términos desplegables.</p></details> | [![Abrir HTML Interactivo](https://img.shields.io/badge/Abrir-HTML%20Interactivo-9cf?style=for-the-badge\&logo=html5\&logoColor=white)](https://htmlpreview.github.io/?https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Simetria_glosario_grupos_grafos_bigdata.html) <br><br> [![Ver Archivo en GitHub](https://img.shields.io/badge/Ver%20Archivo-GitHub-181717?style=for-the-badge\&logo=github)](https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/main/src/classroom/graphs/recursos/Simetria_glosario_grupos_grafos_bigdata.html) |
---
