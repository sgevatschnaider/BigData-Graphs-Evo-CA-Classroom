...
Esta sección reúne una serie de materiales HTML interactivos y una lectura complementaria orientados a estudiar, de manera articulada, cómo se relacionan la regularidad en la conectividad, la estructura topológica de las redes, la transición entre orden y aleatoriedad, y la representación de objetos en dimensiones superiores.
