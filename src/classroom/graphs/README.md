...
Estos dos recursos deben quedar al final. Primero se consulta el glosario para consolidar vocabulario técnico y luego se utiliza el cuestionario como instancia de autoevaluación, repaso y preparación de clase.
