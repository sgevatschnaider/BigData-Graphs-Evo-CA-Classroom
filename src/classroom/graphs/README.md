...
## ​ Los Puentes de Königsberg y el Teorema del Apretón de Manos

| 📄 Recurso | 📥 Acceso |
|---|---|
| **Los Puentes de Königsberg y el Teorema del Apretón de Manos (Taller Interactivo)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este cuaderno interactivo explora el célebre **problema de los siete puentes de Königsberg**, presentado por Euler en 1736, y cómo condujo al nacimiento de la teoría de grafos. A través del **teorema del apretón de manos**, se ilustra por qué en un grafo el número de vértices de grado impar debe ser par, y cómo esto impide la existencia de un recorrido o ciclo euleriano en el grafo correspondiente a la ciudad original. El cuaderno incluye visualizaciones generadas con <code>networkx</code> y <code>matplotlib</code>, incrustadas en el notebook con Base64 y enriquecidas con HTML interactivo (modo claro/oscuro, secciones colapsables) para una experiencia educativa intuitiva.</p></details> | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-blue?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/f0b4a63fa7ecf6274ca4b42b54f7e35e0af1e373/src/classroom/graphs/notebooks/Los_puentes_de_K%C3%B6nigsberg_y_el_teorema_de_apret%C3%B3n_de_manos.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sgevatschnaider/BigData-Graphs-Evo-CA-Classroom/blob/f0b4a63fa7ecf6274ca4b42b54f7e35e0af1e373/src/classroom/graphs/notebooks/Los_puentes_de_K%C3%B6nigsberg_y_el_teorema_de_apret%C3%B3n_de_manos.ipynb) |
