...
| **Modelo Erdős–Rényi (G(n,p))** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Generador aleatorio <code>G(n,p)</code> con control de <code>p</code>. Visualiza la emergencia de la componente gigante (umbral <code>p≈1/n</code>) y la conectividad (<code>p≈ln(n)/n</code>), muestra estadísticas (nodos, aristas, componentes, tamaño de la mayor componente, <code>E[m]=p·C(n,2)</code>) y anima el grafo con fuerzas.</p></details> | [![Ver Página Web](https://img.shields.io/badge/Abrir%20Página-Interactiva-brightgreen?style=for-the-badge&logo=html5)](https://sgevatschnaider.github.io/GraphAI-Data-Science-ML/recursos/Modelo%20Erd%C5%91s%E2%80%93R%C3%A9nyi.html) |
